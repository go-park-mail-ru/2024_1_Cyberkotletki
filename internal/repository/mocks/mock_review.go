...
func (mr *MockReviewMockRecorder) AddReview(review interface{}) *gomock.Call {
...
func (mr *MockReviewMockRecorder) DeleteReviewByID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetContentReviewByAuthor(authorID, contentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetLatestReviews(limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetReviewByID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetReviewsByAuthorID(authorID, page, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetReviewsByContentID(contentID, page, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetReviewsCountByAuthorID(authorID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetReviewsCountByContentID(contentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) IsVotedByUser(reviewID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) UnVoteReview(reviewID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) UpdateReview(review interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) VoteReview(reviewID, userID, like interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
