...
func (mr *MockReviewMockRecorder) CreateReview(create interface{}) *gomock.Call {
...
func (mr *MockReviewMockRecorder) DeleteReview(reviewID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) EditReview(update interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetContentReviews(contentID, count, page interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetLatestReviews(count interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetReview(reviewID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) GetUserReviews(userID, count, page interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) IsVotedByUser(userID, reviewID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) UnVoteReview(userID, reviewID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReviewMockRecorder) VoteReview(userID, reviewID, vote interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
