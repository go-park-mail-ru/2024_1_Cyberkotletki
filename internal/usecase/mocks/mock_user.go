...
func (mr *MockUserMockRecorder) UpdateAvatar(userID, reader interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserMockRecorder) UpdateInfo(userID, update interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserMockRecorder) UpdatePassword(userID, update interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
