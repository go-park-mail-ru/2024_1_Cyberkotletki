...
func (mr *MockCompilationMockRecorder) GetCompilationContent(compID, page interface{}) *gomock.Call {
...
func (mr *MockCompilationMockRecorder) GetCompilationsByCompilationType(compTypeID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
